...
window.addEventListener('DOMContentLoaded', () => {
  ...
  function quickAutosave() {
    ...
    const payload = {
      ...
      playerInventory: window.playerInventory ? JSON.parse(JSON.stringify(window.playerInventory)) : [],
      playerEquipment: window.playerEquipment ? JSON.parse(JSON.stringify(window.playerEquipment)) : {},
      _nextItemId: window._nextItemId || 1,
