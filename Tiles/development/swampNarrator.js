...
const NarratorLines = {
    tile: {
        swamp: [
            "The humid swamp gurgles beneath your feet.",
            "Thick mud slows your steps in the swamp.",
            "You hear distant croaks echoing through the bog.",
            "A cloud of gnats swirls around your head.",
            "The air is heavy with the scent of decay.",
            "You spot a snake slithering through the muck.",
            "Water bubbles up from beneath the mossy ground.",
            "A fallen branch sinks slowly into the mire.",
            "You see strange plants thriving in the wet soil.",
            "The ground squelches with every step you take.",
            "A chorus of frogs erupts as you pass by.",
            "You notice animal tracks pressed into the mud.",
            "A patch of cattails sways in the breeze.",
            "You glimpse a turtle sliding off a log into the water.",
            "A dragonfly hovers above the murky surface.",
            "The swamp's stillness is broken by a sudden splash.",
            "You brush past tall reeds dripping with moisture.",
            "A distant bird calls out from the foggy marsh.",
            "You spot a cluster of mushrooms on a rotting stump.",
            "The air buzzes with the sound of insects."
        ]
    },
    ...
    allyFlirtEnemy: (allyName, enemyName, gender, plural = false) => {
        // Ally flirting with enemy: mysterious, primal, swamp-themed
        const lines = [
            `${allyName} emerges from the misty swamp depths, mud glistening on GENDER3 skin like war paint. GENDER1 approaches ${enemyName} with predatory grace, the murky water swirling around GENDER3 legs as GENDER1 moves through the atmospheric gloom.`,
            `${allyName} finds a patch of solid ground among the bog and beckons ${enemyName} with glowing eyes. GENDER3 silhouette is mysterious against the hanging moss and twisted cypress trees, creating an aura of dangerous allure.`,
            `${allyName} uses the swamp's natural acoustics to GENDER3 advantage, GENDER3 sultry call echoing through the mist. The haunting sound carries across the water, drawing ${enemyName} deeper into the wetland's embrace.`,
            `${allyName} discovers a rare orchid blooming on a fallen log and plucks it carefully, offering the exotic flower to ${enemyName}. The beautiful bloom stands out starkly against the swamp's dark palette, like ${allyName}'s beauty in the wilderness.`,
            `${allyName} perches on a moss-covered stone that rises from the murky water, GENDER3 reflection shimmering in the dark surface below. GENDER1 trails one finger through the water, creating ripples that catch what little light filters through the canopy.`,
            `${allyName} weaves between the cypress knees with fluid grace, appearing and disappearing in the mist like a swamp spirit. GENDER3 game of hide-and-seek among the twisted roots creates irresistible mystery and intrigue.`,
            `${allyName} finds where fireflies dance in the humid air and captures one gently in GENDER3 cupped hands. GENDER1 offers the glowing insect to ${enemyName}, the tiny light pulsing like a captured star in the swamp's darkness.`,
            `${allyName} steps onto a floating log with perfect balance, extending GENDER3 hand toward ${enemyName}. "Trust me," GENDER1 whispers through the mist, "I know all the swamp's secrets... including how to find pleasure in its depths."`,
            `${allyName} discovers a hidden grove where the water runs clear and sweet, beckoning ${enemyName} to share this oasis. The contrast of purity within the wild swamp makes the moment feel magical and intimate.`,
            `${allyName} moves through the brackish water with serpentine grace, GENDER3 wake creating phosphorescent trails that glow in the darkness. The otherworldly display mesmerizes ${enemyName}, drawing them toward this swamp enchantress.`
        ];
        return lines.map(line => applyPronouns(line, gender, plural));
    },

    allyFeastSuccess: (allyName, enemyType) => [
        `${allyName} strikes from the concealing mist, the ${enemyType} unable to see the attack coming until it's too late. The hunt ends quickly in the murky water as ${allyName} claims GENDER3 swamp victory.`,
        `${allyName} uses the treacherous bog to GENDER3 advantage, driving the ${enemyType} into unstable ground where they become trapped. The wetland becomes ${allyName}'s ally as GENDER1 secures GENDER3 feast.`,
        `${allyName} emerges from beneath the dark water like a primordial predator, catching the ${enemyType} completely unaware. The ancient swamp witnesses another successful hunt as ${allyName} drags GENDER3 prize into the depths.`,
        `${allyName} herds the ${enemyType} through winding channels where the footing is uncertain and escape impossible. The labyrinthine waterways trap the prey, allowing ${allyName} to feast among the cypress shadows.`,
        `${allyName} uses the hanging moss as camouflage, dropping down onto the ${enemyType} when they pass beneath. The swamp's natural curtains conceal GENDER3 predatory success from all but the watching herons.`,
        `${allyName} corners the ${enemyType} on a small island surrounded by quicksand and alligator-infested waters. With nowhere to flee, the prey becomes ${allyName}'s well-earned meal in the heart of the wetlands.`,
        `${allyName} moves through the swamp with the patience of a crocodile, striking only when the ${enemyType} ventures too close to the water's edge. The muddy banks bear witness to another successful hunt.`,
        `${allyName} uses the swamp's deceptive nature to GENDER3 advantage, leading the ${enemyType} into a dead-end channel. Trapped between tangled roots and murky water, the prey cannot escape GENDER3 swamp predator.`
    ],

    allyFeastFail: (allyName, enemyType) => [
        `${allyName} lunges through the swamp mist, but the ${enemyType} vanishes into a hollow cypress like a ghost. The ancient tree swallows them whole, leaving ${allyName} circling the trunk in frustration.`,
        `${allyName} pursues the ${enemyType} through the bog, but steps into quicksand instead. While GENDER1 struggles to free GENDER3 legs, GENDER3 prey escapes across the firmer ground beyond the wetlands.`,
        `${allyName} tries to use the hanging moss for cover, but gets tangled in the strands instead. The ${enemyType} watches GENDER3 undignified struggle before fleeing toward the safety of higher ground.`,
        `${allyName} strikes from the murky water, but disturbs a sleeping alligator in the process. The massive reptile's furious thrashing sends both ${allyName} and the ${enemyType} scrambling in opposite directions.`,
        `${allyName} attempts to corner the ${enemyType}, but misjudges the water depth and sinks in over GENDER3 head. By the time GENDER1 surfaces, sputtering and muddy, GENDER3 prey has vanished into the mist.`,
        `${allyName} chases the ${enemyType} across floating logs, but the rotten wood gives way beneath GENDER3 weight. The splash alerts every creature in the swamp, including the prey who flees the commotion.`,
        `${allyName} tries to use the swamp's acoustics to confuse the ${enemyType}, but GENDER3 call awakens a murder of crows. The raucous cawing drowns out all stealth, allowing the prey to escape in the chaos.`
    ],

    allyFeedSuccess: (allyName, enemyType) => [
        `${allyName} discovers a grove of wild berries growing on higher ground and shares them with the ${enemyType}. The sweet fruit's purity amid the swamp's darkness demonstrates GENDER3 ability to find goodness anywhere.`,
        `${allyName} finds a spring of clear water bubbling up from deep underground and offers it to the thirsty ${enemyType}. This gift of pure refreshment in the brackish wetlands creates instant trust and gratitude.`,
        `${allyName} weaves a crown of swamp orchids and spanish moss, placing it gently on the ${enemyType}'s head. The exotic beauty of the wetland crown wins over their heart completely with its wild elegance.`,
        `${allyName} demonstrates the swamp's hidden safety by resting peacefully among the cypress roots, showing the ${enemyType} that danger has passed. The ancient trees' protection convinces them to join your group.`,
        `${allyName} collects luminescent mushrooms and shares their ghostly glow with the ${enemyType}. The magical light in the dark swamp creates wonder and trust between them.`,
        `${allyName} finds edible water plants and teaches the ${enemyType} which ones are safe to eat. This knowledge of the swamp's hidden bounty proves GENDER3 wisdom and good intentions.`,
        `${allyName} discovers where turtles gather to bask and invites the ${enemyType} to watch them in peaceful silence. The shared moment of swamp serenity builds lasting friendship.`,
        `${allyName} shows the ${enemyType} how to read the wetland's signs - where the water runs deep, which paths are safe. This swamp wisdom shared freely creates deep understanding and trust.`
    ],

    allyFeedFail: (allyName, enemyType) => [
        `${allyName} offers swamp berries to the ${enemyType}, but they're infested with insects. The unpleasant surprise sends the ${enemyType} spitting and fleeing toward cleaner environments.`,
        `${allyName} tries to impress the ${enemyType} with GENDER3 swamp knowledge, but leads them into a patch of stinging nettles. The painful encounter ruins any trust they might have built.`,
        `${allyName} attempts to share the wetland's beauty with the ${enemyType}, but steps on a snake instead. GENDER3 panicked dance and the serpent's angry hissing destroy the peaceful atmosphere.`,
        `${allyName} gathers glowing mushrooms for the ${enemyType}, but chooses the poisonous variety by mistake. The toxic effects make meaningful friendship impossible in the dark swamp.`,
        `${allyName} tries to demonstrate swamp navigation, but gets hopelessly lost in the maze of channels. The ${enemyType} loses faith in GENDER3 abilities and seeks more reliable company.`,
        `${allyName} offers to teach the ${enemyType} about water plants, but disturbs a nest of angry wasps. The defensive swarm sends both creatures fleeing in different directions.`,
        `${allyName} attempts to create atmosphere by calling across the water, but GENDER3 voice cracks embarrassingly in the humid air. The ${enemyType} takes this as a sign to seek better company elsewhere.`
    ],

    allyFuckSuccess: (allyName, enemyType, gender, plural = false) => [
        `${allyName} and the ${enemyType} find a hidden grove where ancient cypress trees create a natural sanctuary. Surrounded by the swamp's mysterious embrace, they explore their desires on a bed of soft moss and fallen leaves.`,
        `${allyName} leads the ${enemyType} to a secluded oxbow lake where the water runs clear and warm. In this pristine oasis within the wild wetlands, they connect intimately as fireflies dance around them.`,
        `${allyName} and the ${enemyType} discover each other on a floating platform of interwoven logs and vines. Their passionate encounter creates ripples that spread across the dark water, witnessed only by the patient herons.`,
        `${allyName} creates a bower of hanging moss and exotic orchids for GENDER3 and the ${enemyType} to share. In this swamp paradise, they find pleasure while the mist conceals their intimate moments from the world.`,
        `${allyName} and the ${enemyType} wade into a warm spring that bubbles up through the swamp floor. The natural hot water enhances their connection, making every touch electric in the mystical wetland setting.`,
        `${allyName} guides the ${enemyType} to where phosphorescent algae make the water glow with each movement. Their coupling creates trails of light in the dark swamp, their passion literally illuminating the wetlands.`,
        `${allyName} and the ${enemyType} find shelter in a hollow cypress wide enough for two. High above the swamp floor, they share intimacy in this tree-tower sanctuary as the mist swirls below.`,
        `${allyName} shows the ${enemyType} a grotto where ancient magic still lingers in the humid air. In this mystical swamp chamber, their intimate dance feels blessed by primordial spirits of the wetlands.`
    ],

    allyFuckFail: (allyName, enemyType) => [
        `${allyName} and the ${enemyType} settle into a romantic spot, but discover it's built over a gator nest. The territorial parents emerge with snapping jaws, sending both lovers scrambling to safety.`,
        `${allyName} tries to create intimacy on a moss-covered log, but it's home to an entire colony of fire ants. The painful bites send them both diving into the murky water to escape.`,
        `${allyName} and the ${enemyType} begin to connect by the water's edge, but disturb a sleeping cottonmouth. The venomous snake's aggressive warning display kills any romantic mood instantly.`,
        `${allyName} attempts to seduce the ${enemyType} with swamp magic, but accidentally summons a cloud of mosquitoes instead. The bloodthirsty swarm makes romance absolutely impossible.`,
        `${allyName} and the ${enemyType} find a beautiful spot, but it turns out to be directly downwind from a sulfur spring. The rotten egg smell makes intimate contact unbearable.`,
        `${allyName} tries to create atmosphere by imitating bird calls, but accidentally mimics the distress cry of an owl. Every predator in the swamp comes investigating, ruining their privacy.`,
        `${allyName} and the ${enemyType} settle onto what seems like solid ground, but it's actually a floating mat of vegetation. They sink slowly into the bog, their romantic moment becoming a muddy rescue operation.`
    ],
